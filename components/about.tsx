...
export default function About() {
  ...
  return (
    <>
    <h2 className="uppercase text-3xl tracking-[20px] text-center mx-auto mb-10" >About</h2> 
    <motion.section
      ref={ref}
    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        <h4 className="text-3xl mt-10 font-semibold">Here is a <span className="underline decoration-[#F7AB0A]/50">little</span> background</h4> 
          <p className="text-sm">
